...
impl FixtureCell {
    #[allow(dead_code)]
    pub fn from_cell(cell: &a11y_vt100::Cell) -> Self {
        Self {
...
pub struct FixtureScreen {
    ...
    mouse_protocol_mode: a11y_vt100::MouseProtocolMode,
    #[serde(
        default,
    ...
    mouse_protocol_encoding: a11y_vt100::MouseProtocolEncoding,
}
...
impl FixtureScreen {
    ...
    #[allow(dead_code)]
    pub fn from_screen(screen: &a11y_vt100::Screen) -> Self {
        let empty_screen = a11y_vt100::Parser::default().screen().clone();
...
fn deserialize_color<'a, D>(
    deserializer: D,
) -> std::result::Result<a11y_vt100::Color, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let val = <Option<String>>::deserialize(deserializer)?;
    match val {
        None => Ok(a11y_vt100::Color::Default),
        Some(x) if x.starts_with('#') => {
            ...
            Ok(a11y_vt100::Color::Rgb(r, g, b))
        }
        Some(x) => Ok(a11y_vt100::Color::Idx(
...
{
    let s = match color {
        a11y_vt100::Color::Default => unreachable!(),
        a11y_vt100::Color::Idx(n) => format!("{n}"),
        a11y_vt100::Color::Rgb(r, g, b) => format!("#{r:02x}{g:02x}{b:02x}"),
    };
...
fn deserialize_mouse_protocol_mode<'a, D>(
    deserializer: D,
) -> std::result::Result<a11y_vt100::MouseProtocolMode, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let name = <String>::deserialize(deserializer)?;
    match name.as_ref() {
        "none" => Ok(a11y_vt100::MouseProtocolMode::None),
        "press" => Ok(a11y_vt100::MouseProtocolMode::Press),
        "press_release" => Ok(a11y_vt100::MouseProtocolMode::PressRelease),
        "button_motion" => Ok(a11y_vt100::MouseProtocolMode::ButtonMotion),
        "any_motion" => Ok(a11y_vt100::MouseProtocolMode::AnyMotion),
        _ => unimplemented!(),
    }
}

fn serialize_mouse_protocol_mode<S>(
    mode: &a11y_vt100::MouseProtocolMode,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    let s = match mode {
        a11y_vt100::MouseProtocolMode::None => "none",
        a11y_vt100::MouseProtocolMode::Press => "press",
        a11y_vt100::MouseProtocolMode::PressRelease => "press_release",
        a11y_vt100::MouseProtocolMode::ButtonMotion => "button_motion",
        a11y_vt100::MouseProtocolMode::AnyMotion => "any_motion",
    };
    serializer.serialize_str(s)
}
...
fn deserialize_mouse_protocol_encoding<'a, D>(
    deserializer: D,
) -> std::result::Result<a11y_vt100::MouseProtocolEncoding, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let name = <String>::deserialize(deserializer)?;
    match name.as_ref() {
        "default" => Ok(a11y_vt100::MouseProtocolEncoding::Default),
        "utf8" => Ok(a11y_vt100::MouseProtocolEncoding::Utf8),
        "sgr" => Ok(a11y_vt100::MouseProtocolEncoding::Sgr),
        _ => unimplemented!(),
    }
}

fn serialize_mouse_protocol_encoding<S>(
    encoding: &a11y_vt100::MouseProtocolEncoding,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    let s = match encoding {
        a11y_vt100::MouseProtocolEncoding::Default => "default",
        a11y_vt100::MouseProtocolEncoding::Utf8 => "utf8",
        a11y_vt100::MouseProtocolEncoding::Sgr => "sgr",
    };
    serializer.serialize_str(s)
}
...
fn assert_produces(input: &[u8], expected: &FixtureScreen) {
    let mut parser = a11y_vt100::Parser::default();
