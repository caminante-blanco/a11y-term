...
pub fn compare_screens(
    got: &a11y_vt100::Screen,
    expected: &a11y_vt100::Screen,
) -> bool {
    ...
    is!(
        Bytes(&got.contents_diff(a11y_vt100::Parser::default().screen())),
        Bytes(&expected.contents_diff(a11y_vt100::Parser::default().screen()))
    );
...
pub fn contents_formatted_reproduces_screen(screen: &a11y_vt100::Screen) -> bool {
    ...
    let mut new_parser = a11y_vt100::Parser::default();
...
pub fn rows_formatted_reproduces_screen(screen: &a11y_vt100::Screen) -> bool {
...
pub fn contents_diff_reproduces_state_from_screens(
    prev_screen: &a11y_vt100::Screen,
    screen: &a11y_vt100::Screen,
) -> bool {
